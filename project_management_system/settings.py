...
MIDDLEWARE = [
    'project_management_system.middleware.TenantTutorialMiddleware',
...
TEMPLATES = [
    {
        ...
        'DIRS': [
            ...
            os.path.join(BASE_DIR, 'project_management/templates'),
            os.path.join(BASE_DIR, 'users', 'templates'),
            os.path.join(BASE_DIR, 'default_page', 'templates'),
        ],
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
                ...
                'project_management_system.middleware.client_company_name_logo',
            ],
        },
    },
]
...
PUBLIC_SCHEMA_URLCONF = 'project_management_system.urls_public'
